...
[![My Skills](https://skillicons.dev/icons?i=js,ts,html,css,next,vue,nuxtjs,react,tailwind,vuetify,sass,threejs,gatsby,graphql,figma,angular,flutter,python,flask,fortran,cpp,cs,arduino,cypress,dotnet,firebase,unity,express,rust,blender,jquery,lua,latex,mysql,matlab, swagger)](https://skillicons.dev)
...
Feel free to explore and may the Force be with you!
